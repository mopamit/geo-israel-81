const SITE_LIBRARY = [
  ...
  },
  {
    ...
    position:{x:57.67,y:41.02}, displayPosition:{x:57.55,y:41.15}, hitEllipse:{x:57.67,y:41.02,rx:1.55,ry:.72},
  ...
  },
  {
    ...
    position:{x:58.31,y:39.99}, displayPosition:{x:59.10,y:41.15}, hitEllipse:{x:58.31,y:39.99,rx:1.55,ry:.72},
