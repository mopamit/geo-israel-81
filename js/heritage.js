const SITE_LIBRARY = [
  {
    ...
    position:{x:60.31,y:17.87}, hitEllipse:{x:60.31,y:17.87,rx:3.0,ry:1.45},
  ...
  },
  {
    ...
    position:{x:60.37,y:15.21}, hitEllipse:{x:60.37,y:15.21,rx:3.0,ry:1.4},
  ...
  },
  {
    ...
    position:{x:78.93,y:15.60}, hitEllipse:{x:78.93,y:15.60,rx:2.9,ry:1.35},
  ...
  },
  {
    ...
    position:{x:36.92,y:31.47}, hitEllipse:{x:36.92,y:31.47,rx:2.7,ry:1.25},
  ...
  },
  {
    ...
    position:{x:35.64,y:32.67}, hitEllipse:{x:35.64,y:32.67,rx:2.6,ry:1.2},
  ...
  },
  {
    ...
    position:{x:36.98,y:37.16}, hitEllipse:{x:36.98,y:37.16,rx:2.85,ry:1.3},
  ...
  },
  {
    ...
    position:{x:58.70,y:40.43}, displayPosition:{x:59.05,y:41.58}, hitEllipse:{x:58.70,y:40.43,rx:2.05,ry:1.0},
  ...
  },
  {
    ...
    position:{x:57.67,y:41.02}, displayPosition:{x:57.45,y:41.72}, hitEllipse:{x:57.67,y:41.02,rx:1.95,ry:0.98},
  ...
  },
  {
    ...
    position:{x:58.31,y:39.99}, displayPosition:{x:58.55,y:40.28}, hitEllipse:{x:58.31,y:39.99,rx:1.95,ry:0.98},
  ...
  },
  {
    ...
    position:{x:33.25,y:63.92}, hitEllipse:{x:33.25,y:63.92,rx:3.0,ry:1.4},
  ...
  },
  {
    ...
    position:{x:28.29,y:54.76}, hitEllipse:{x:28.29,y:54.76,rx:2.9,ry:1.3},
  ...
  },
  {
    ...
    position:{x:39.18,y:54.88}, hitEllipse:{x:39.18,y:54.88,rx:2.9,ry:1.3},
