const RIVER_LIBRARY = [
  {
    ...
    hitTolerance: 18,
    path: [[626,517],[622,508],[617,500],[612,493],[607,484],[599,479],[590,477],[581,475],[572,471],[564,465],[558,458],[552,452],[545,446],[536,442],[536,433],[534,424],[532,415],[527,408],[521,400],[514,392],[514,383],[509,376],[503,368],[494,366],[491,357],[490,354]]
  },
  {
    id: 'alexander',
    name: 'נחל אלכסנדר',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 18,
    path: [[528,754],[521,749],[512,749],[503,748],[494,748],[485,748],[476,746],[466,744],[463,735],[463,726],[465,717],[464,708],[464,700],[460,691],[456,682],[455,673],[454,664],[448,656],[439,651],[430,651],[421,653],[412,647],[406,641],[397,639],[397,637]]
  },
  {
    id: 'dan',
    name: 'נחל דן',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 9,
    path: [[845,85],[839,93],[834,102],[829,112],[825,122],[821,132],[818,141],[818,150],[822,156]]
  },
  {
    id: 'banias',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 9,
    path: [[874,112],[866,119],[860,128],[853,137],[847,145],[839,152],[831,157],[823,160]]
  },
  {
    id: 'snir',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 10,
    path: [[809,43],[808,56],[809,69],[813,81],[814,94],[811,107],[804,119],[795,131],[795,142],[804,151],[818,157]]
  },
  {
    id: 'saar',
    name: 'נחל סער',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 10,
    path: [[927,114],[915,122],[905,129],[893,137],[881,142],[870,145],[858,147],[847,152],[835,156],[825,160]]
  },
  {
    id: 'taninim',
    name: 'נחל תנינים',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 16,
    path: [[418,541],[427,540],[436,542],[442,550],[451,551],[460,551],[469,546],[476,540],[482,533],[490,528],[499,526],[508,526],[517,526],[526,524],[535,523],[541,521]]
  },
  {
    id: 'sorek',
    name: 'נחל שורק',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 18,
    path: [[584,992],[585,1000],[586,1009],[590,1018],[593,1027],[591,1036],[582,1038],[576,1045],[567,1050],[563,1059],[554,1061],[545,1065],[536,1069],[527,1070],[518,1071],[509,1070],[500,1066],[491,1066],[482,1066],[473,1068],[464,1068],[455,1069],[446,1070],[437,1066],[429,1061],[423,1055],[418,1047],[410,1041],[402,1036],[393,1033],[384,1033],[375,1033],[366,1030],[357,1025],[348,1022],[339,1018],[334,1009],[329,1000],[329,992],[327,983],[326,974],[325,965],[320,956],[313,950],[304,947],[303,948]]
  },
  {
    id: 'paran',
    name: 'נחל פארן',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 20,
    path: [[302,2176],[309,2170],[314,2161],[321,2153],[327,2147],[332,2139],[334,2130],[341,2124],[345,2115],[352,2107],[358,2101],[363,2092],[366,2083],[367,2074],[374,2068],[381,2063],[385,2054],[393,2049],[398,2041],[403,2033],[412,2029],[421,2027],[430,2025],[438,2031],[447,2035],[456,2036],[465,2038],[474,2038],[483,2039],[491,2034],[496,2026],[503,2020],[512,2017],[521,2016],[530,2012],[539,2007],[548,2002],[555,1996],[563,1991],[567,1987]]
  },
  {
    id: 'david',
    name: 'נחל דוד',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 14,
    path: [[709,1262],[700,1259],[692,1254],[683,1253],[678,1245],[669,1242],[661,1237],[653,1231],[646,1229]]
  }
];

const REQUIRED_COUNT = 3;
const MAP_VIEWBOX = { width: 1000, height: 2600 };
const STORAGE_KEY = 'amitRiversStationV7';
