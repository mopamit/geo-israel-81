const RIVER_LIBRARY = [
  {
    ...
    hitTolerance: 28,
    path: [[488,354],[511,381],[522,419],[548,444],[576,463],[611,504],[630,528]]
  },
  {
    id: 'alexander',
    name: 'נחל אלכסנדר',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 30,
    path: [[385,635],[412,648],[438,679],[450,724],[458,756],[490,737],[528,749]]
  },
  {
    id: 'dan',
    name: 'נחל דן',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 17,
    path: [[818,57],[813,83],[816,112],[813,140],[808,158]]
  },
  {
    id: 'banias',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 17,
    path: [[833,57],[830,83],[825,114],[822,141],[814,158]]
  },
  {
    id: 'snir',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 17,
    path: [[805,43],[796,71],[797,102],[795,132],[799,157]]
  },
  {
    id: 'saar',
    name: 'נחל סער',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 16,
    path: [[849,47],[846,72],[840,95],[835,114],[832,132]]
  },
  {
    id: 'taninim',
    name: 'נחל תנינים',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 28,
    path: [[414,535],[442,527],[477,521],[505,534],[543,548]]
  },
  {
    id: 'sorek',
    name: 'נחל שורק',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 30,
    path: [[299,944],[322,965],[348,1002],[387,1016],[425,1041],[474,1064]]
  },
  {
    id: 'paran',
    name: 'נחל פארן',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 32,
    path: [[314,2161],[348,2096],[387,2031],[438,2005],[490,2018],[528,1994],[568,1983]]
  },
  {
    id: 'david',
    name: 'נחל דוד',
    ...
    basinChoices: ['אגן הים התיכון', 'אגן הירדן והכנרת', 'אגן ים המלח והערבה'],
    hitTolerance: 25,
    path: [[616,1215],[651,1231],[684,1231],[709,1251]]
  }
];
