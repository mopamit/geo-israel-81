const SETTLEMENT_LIBRARY = [
  {
    ...
    position:{x:80.58,y:1.90}, displayPosition:{x:80.58,y:1.90}, hitEllipse:{x:80.58,y:1.90,rx:3.2,ry:1.55},
  ...
  },
  {
    ...
    position:{x:54.12,y:6.71}, hitEllipse:{x:54.12,y:6.71,rx:3.2,ry:1.55},
  ...
  },
  {
    ...
    position:{x:91.88,y:5.55}, hitEllipse:{x:91.88,y:5.55,rx:3.0,ry:1.55},
  ...
  },
  {
    ...
    position:{x:76.55,y:21.09}, displayPosition:{x:76.55,y:21.09}, hitEllipse:{x:76.55,y:21.09,rx:3.0,ry:1.55},
  ...
  },
  {
    ...
    position:{x:61.47,y:69.63}, hitEllipse:{x:61.47,y:69.63,rx:3.3,ry:1.65},
  ...
  },
  {
    ...
    position:{x:15.26,y:65.63}, displayPosition:{x:15.26,y:65.63}, hitEllipse:{x:15.26,y:65.63,rx:3.1,ry:1.6},
  ...
  },
  {
    ...
    position:{x:12.50,y:63.18}, displayPosition:{x:12.50,y:63.18}, hitEllipse:{x:12.50,y:63.18,rx:3.1,ry:1.6},
  ...
  },
  {
    ...
    position:{x:5.97,y:55.03}, hitEllipse:{x:5.97,y:55.03,rx:3.0,ry:1.6},
  ...
  },
  {
    ...
    position:{x:20.34,y:45.81}, hitEllipse:{x:20.34,y:45.81,rx:3.2,ry:1.6},
  ...
  },
  {
    ...
    position:{x:12.40,y:52.72}, hitEllipse:{x:12.40,y:52.72,rx:3.2,ry:1.6},
  ...
  },
  {
    ...
    position:{x:79.00,y:2.82}, displayPosition:{x:79.00,y:2.82}, hitEllipse:{x:79.00,y:2.82,rx:3.0,ry:1.5},
  ...
  },
  {
    ...
    position:{x:78.51,y:23.09}, displayPosition:{x:78.51,y:23.09}, hitEllipse:{x:78.51,y:23.09,rx:3.0,ry:1.55},
...
function resetSidebar(){els.mapInstructions.hidden=true;els.borderStep.hidden=true;els.hintBtn.hidden=true;clearFeedback()}
...
function chooseBorder(choice,button){
  if(state.stage!=='border')return;

  if(choice!==state.current.border){
    button.classList.add('wrong');
    setTimeout(()=>button.classList.remove('wrong'),400);
    showFeedback('בדקו שוב את מיקום היישוב ואת קו הגבול הסמוך אליו.','try-again');
    return;
  }

  state.score+=100;
  state.completedIds.push(state.current.id);
  if(state.requiredCompleted<3)state.requiredCompleted++;
  else state.bonusCompleted++;

  showFeedback(`נכון. ${state.current.name} נמצא סמוך ל${state.current.border}. היישוב הושלם ונוסף לאוסף.`,'success');
  updateHud();
  renderCollection();
  saveProgress();
  setTimeout(showPassport,650);
}
